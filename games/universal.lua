...
local hash = loadstring(downloadFile('Clae/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('Clae/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('Clae/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('Clae/profiles/whitelist.json') and readfile('Clae/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('Clae/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('Clae/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('Clae/assets/new/radaricon.png'),
