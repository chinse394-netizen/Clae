...
local getcustomassets = {
	['Clae/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['Clae/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['Clae/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['Clae/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['Clae/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['Clae/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['Clae/assets/old/info.png'] = 'rbxasset://info.png',
	['Clae/assets/old/pin.png'] = 'rbxasset://pin.png',
	['Clae/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['Clae/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['Clae/assets/old/search.png'] = 'rbxasset://search.png',
	['Clae/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['Clae/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['Clae/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['Clae/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['Clae/assets/old/textvape.png'] = 'rbxasset://textvape.png',
	['Clae/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['Clae/assets/old/vape.png'] = 'rbxassetid://14373395239',
	['Clae/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('Clae/assets/old/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('Clae/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('Clae/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('Clae/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('Clae/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('Clae/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('Clae/assets/old/vape.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('Clae/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('Clae/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('Clae/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('Clae/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('Clae/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('Clae/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('Clae/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('Clae/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('Clae/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('Clae/assets/old/profilesicon.png'),
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('Clae/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
VapeLogo.Image = getcustomasset('Clae/assets/old/textvape.png')
...
VapeLogoV4.Image = getcustomasset('Clae/assets/old/textv4.png')
