...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/chinse394-netizen/Clae/claude/migrate-miyonpuffnoodles-levi-76eojf/NewMainScript.lua", true))()
```
...
1. Deleting the Clae folder (WITH THE GAME CLOSED).
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/chinse394-netizen/Clae/refs/heads/claude/migrate-miyonpuffnoodles-levi-76eojf/NewMainScript.lua)
